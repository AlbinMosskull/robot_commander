...
from robot_commander.image_processing.agent_stream_camera import AgentStreamCamera
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Capture checkerboard images from the robot camera and compute intrinsics.")
    ...
    if not args.skip_capture:
        client = AgentClient()
        with AgentStreamCamera(client) as cam:
